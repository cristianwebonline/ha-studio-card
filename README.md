...
Un pannello nella barra laterale di Home Assistant per comporre le dashboard trascinando le card già pronte — invece di scrivere configurazioni a mano o affidarsi all'editor generico di Lovelace.

## Cos'è (e cosa non è)

Faber Studio non è un'altra card da aggiungere a una dashboard esistente: è un'app a sé, pensata per stare da sola in una vista dedicata (di tipo "panel") con una sua voce nel menu laterale. Da lì si sceglie una dashboard/vista già esistente e la si modifica visivamente.
...
2. Installa "Faber Studio" e aggiungi la risorsa dashboard.
...
Faber Studio scrive direttamente sulle dashboard tramite l'API di Home Assistant — va installato solo da chi ha accesso da amministratore, come tutte le altre card di questa famiglia.
